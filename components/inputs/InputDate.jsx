  ...
  return (
    <label htmlFor="fecha" className="flex flex-col text-sm">
      ...
      <div className= {'relative flex items-center space-x-2'}>
        <input type="date" name="fecha" id="" placeholder={value} className={'w-full h-8 border rounded-md pl-2 border-slate-400 disabled:bg-gray-100 disabled:border-gray-100 outline-none'} />
