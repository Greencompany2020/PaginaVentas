...
export default function UserForm(props) {
  ...
  const validationSchema = Yup.object().shape({
    ...
    Email: Yup.string()
      .email("Ingrese un email con formato valido @example.com")
      .required("Requerido"),
  ...
  const ListGroups = () => {
    if (!groups) return <option value={1}>Sin grupo</option>;
            ...
            <div className="mt-6 space-y-2">
              <div className="flex flex-col space-y-1">
                ...
                <Field
                  ...
                  name="NoEmpleado"
                />
                {errors?.NoEmpleado && touched?.NoEmpleado ? (
                  <span className="font-semibold text-red-500">
                    {errors?.NoEmpleado}
                  </span>
                ) : null}
              ...
              <div className="flex flex-row space-x-4">
                <div className="flex flex-col space-y-1">
                  ...
                  <Field
                    ...
                    id="Clase"
                    name="Clase"
                    className="h-8 border rounded-md border-slate-400 w-20"
                  >
                ...
                <div className="flex flex-col space-y-1">
                  ...
                  <Field
                    ...
                    id="idGrupo"
                    name="idGrupo"
                    className="h-8 border rounded-md border-slate-400 w-44"
                  >
                    <ListGroups />
                  </Field>
                  {errors?.idGrupo && touched?.idGrupo ? (
                    <span className="font-semibold text-red-500">
                      {errors?.idGrupo}
                    </span>
                  ) : null}
