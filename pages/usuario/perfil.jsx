		...
		<>
			<div className="flex flex-col md:flex-row h-full">
				<section className="w-full h-[500px] md:w-[400px] md:h-full bg-gray-200">
					<div className="p-4">
						<div className="flex flex-col items-center md:justify-center space-y-2">
							...
							<button className="text-blue-400 font-bold" onClick={setVisible}>
								Cambiar imagen
							</button>
						</div>
						<div className="mt-8">
							...
							<div className="mt-3 space-y-2">
								...
								<button className="text-blue-400 font-bold" onClick={handleRequestNewPassword}>
									Cambiar Contraseña
								</button>
				...
				<section className="w-full md:h-full">
					<div className="p-4">
						<h4 className=" hidden md:block md:text-right md:text-2xl md:font-bold">
